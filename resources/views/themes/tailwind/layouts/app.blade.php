...
<head>
    ...
    @else
        <title>{{ setting('site.title', 'Cyberenew') . ' - ' . setting('site.description', 'The Software as a Service Starter Kit built on Laravel & Voyager') }}</title>
    @endif
    ...
    <link rel="icon" href="{{ setting('site.favicon', asset('assets/images/dark_icon.png')) }}" type="image/x-icon">
