...
<!-- Section 1 -->
<footer class="<?php if(Request::is('/')): ?><?php echo e('bg-white'); ?><?php else: ?><?php echo e('bg-gray-50'); ?><?php endif; ?>">
    <div class="px-8 pt-16 mx-auto lg:px-12 xl:px-16 max-w-7xl">
        <div class="flex flex-col items-center justify-between py-10 border-t border-solid lg:flex-row border-gray">
            <ul class="flex flex-wrap space-x-5 text-xs">
                <li class="mb-6 text-center flex-full lg:flex-none lg:mb-0">&copy; <?php echo e(date('Y')); ?> <?php echo e(setting('site.title', 'Cyberenew')); ?>, Inc. All rights reserved.</li>
                <li class="lg:ml-6">
...
<?php if(!auth()->guest() && auth()->user()->hasAnnouncements()): ?>
    <?php echo $__env->make('theme::partials.announcements', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>

<!-- Scripts -->
<script src="<?php echo e(asset('themes/' . $theme->folder . '/js/app.js')); ?>"></script>
...
<?php endif; ?>
<?php /**PATH D:\FYP\cybersentinel\resources\views/themes/tailwind/partials/footer.blade.php ENDPATH**/ ?>