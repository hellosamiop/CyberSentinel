...
<script>
    ...
    window.vendor_id = parseInt('<?php echo e(config("wave.paddle.vendor")); ?>');
    ...
    function waveCheckout(plan_id) {
        if(vendor_id){
            ...
            Paddle.Checkout.open({
                product: product,
                email: '<?php if(!auth()->guest()): ?><?php echo e(auth()->user()->email); ?><?php endif; ?>',
...
<?php /**PATH D:\FYP\cybersentinel\wave\src/../resources/views/checkout.blade.php ENDPATH**/ ?>