                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            <?php if (can_impersonate()) : ?>
                                                <a href="<?php echo e(route('impersonate', $data->{$data->getKeyName()})); ?>" class="btn btn-sm btn-warning pull-right" style="margin-right:5px; background:#09cd9f;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FYP\cybersentinel\resources\views/vendor/voyager/users/browse.blade.php ENDPATH**/ ?>